...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1484859678;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        28 => wire__crate__api__memo_set_color_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__memo_set_group_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__memo_set_opacity_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__memo_upsert_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__memos_in_group_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__mobile_strings_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__set_language_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__settings_load_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__settings_save_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__sync_approve_device_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__sync_devices_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__sync_ensure_folder_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__sync_pair_with_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__sync_pairing_code_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__sync_pending_devices_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__sync_rebuild_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__sync_reject_device_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__api__sync_running_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__api__sync_set_paused_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api__sync_set_timing_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__sync_set_versioning_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__sync_start_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__api__sync_stop_impl(port, ptr, rust_vec_len, data_len),
        51 => wire__crate__api__sync_unpair_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__api__sync_verification_code_impl(port, ptr, rust_vec_len, data_len),
        53 => wire__crate__api__update_check_impl(port, ptr, rust_vec_len, data_len),
        54 => wire__crate__api__vault_change_password_impl(port, ptr, rust_vec_len, data_len),
        55 => wire__crate__api__vault_close_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__api__vault_exists_impl(port, ptr, rust_vec_len, data_len),
        57 => wire__crate__api__vault_has_recovery_code_impl(port, ptr, rust_vec_len, data_len),
        58 => wire__crate__api__vault_issue_recovery_code_impl(port, ptr, rust_vec_len, data_len),
        59 => wire__crate__api__vault_key_impl(port, ptr, rust_vec_len, data_len),
        60 => wire__crate__api__vault_name_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__api__vault_open_impl(port, ptr, rust_vec_len, data_len),
        62 => wire__crate__api__vault_open_with_key_impl(port, ptr, rust_vec_len, data_len),
        63 => wire__crate__api__vault_reset_impl(port, ptr, rust_vec_len, data_len),
        64 => wire__crate__api__vault_reset_password_with_recovery_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        65 => wire__crate__api__vault_set_name_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
