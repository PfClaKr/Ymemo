...
메모는 놓아둔 순서를 기억합니다. 데스크톱에서는 목록의 두 행 **사이**로 끌어다 놓으면 그 자리에
놓이고, 폴더 **위**에 놓으면 그 폴더로 들어갑니다. 휴대폰에서는 각 줄 오른쪽의 손잡이를 잡고
끌면 됩니다. 순서는 폴더마다 따로이고 동기화됩니다 — 두 기기가
동시에 정리해도 한쪽이 덮이지 않고 둘 다 남습니다. 아직 정리한 적 없는 폴더는 예전처럼
최근 수정순 그대로입니다.
...
두 화면 모두 목록 위에 찾기 칸이 있습니다. 폴더를 가리지 않고 한 번에 전부 뒤지고 — 메모가
어느 폴더에 있었는지가 바로 잊어버린 그것이니까요 — 제목뿐 아니라 적어 둔 내용까지 봅니다.

### 지우기, 그리고 마음이 바뀔 때

지우면 목록에서 바로 사라지고, 되돌릴 기회가 함께 뜹니다. 데스크톱은 막대로, 휴대폰은
스낵바로. 지우려고 지운 대부분에는 "정말요?"를 묻지 않고, 아니었던 하나는 몇 초 동안 한 번의
클릭으로 돌아옵니다.
...
온 것도 그대로 남습니다. 휴대폰에서는 메모를 길게 눌러 들어갑니다.
...
연결은 두 기기 사이에서 맺지만 보관함은 그렇지 않습니다. 세 번째 기기부터는 각 기기가 **서로를
소개**하므로, 노트북에 연결한 휴대폰과 같은 노트북에 연결한 태블릿이 서로 직접 주고받습니다.
그렇지 않으면 그 둘 사이의 메모가 오가려면 노트북이 켜져 있어야 합니다.

기기를 해제하는 것도 같은 길로 퍼집니다. 지금 들고 있는 기기가 아니라 보관함에 기록되므로 다른
기기들도 함께 그 기기를 놓습니다 — 그러지 않으면 아직 갖고 있던 기기가 곧바로 다시 소개해
버립니다. 다시 연결하면 해제가 풀립니다. 다만 해제한 기기 안까지 손을 뻗지는 않습니다. 이미
그 기기에 있는 메모는 남고 받았던 열쇠도 그대로이니, 이건 **그 기기와 더 이상 공유하지 않는
방법**이지 그 기기를 잠그는 방법은 아닙니다.
